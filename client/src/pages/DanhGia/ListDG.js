...
export default function ListDG() {
    ...
    const loadData = async () => {
        const response = await axios.get("http://localhost:3000/danhgias");
    ...
    return (
        <Box sx={{ width: '100%' }}>
            <Paper sx={{ width: '100%', mb: 2 }}>
                ...
                <Link to={`/adddg`}>
                    <ChatBubbleOutlineOutlinedIcon className='add-icon' sx={{ fontSize: 40 }} />
