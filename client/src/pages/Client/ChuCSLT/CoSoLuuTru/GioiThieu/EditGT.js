...
const EditGT = () => {
    ...
    useEffect(() => {
        axios
            .get(`http://localhost:3000/ct_cslts/${id}`)
    ...
    return (
        <body className='body'>
            <div className="container-addeditcslt">
                <header className='header'>Thông tin giới thiệu</header>

                <form className='form-all' onSubmit={handleSubmit}>
                    <div className="form-addeditcslt first-addeditcslt">
                        <div className="details personal">
                            <span className="title-addeditcslt"></span>

                            <div className="fields-addeditcslt">

                                <div className="input-field-addeditcslt">
